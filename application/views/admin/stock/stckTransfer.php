                                    ...
                                    <div class="table-responsive" style="padding: 10px 25px 10px 10px">
                                        <table class="table dataTable table-striped table-bordered" id="reqGdTblEdt"
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-left" title="Assigned Total / Available Quantity"><span style="color: #76AB3C">ASS. T.</span> / <span style="color: #F69F00">AV. QTY</span></th>
                                ...
                                if (func == 'vew') {
                                    ...
                                    for (var it = 0; it < len2; it++) {
                                        if(item==reqs[it]['itid']){
                                            t.row.add([
                                                '*',
                                                reqs[it]['stcd'] + '<input type="hidden" name="stidEdt[]" value="' + reqs[it]['stid'] + ' ">',
                                                ...
                                                '04 / 06',
                                                '02',
                                                '<button type="button" ' + des + ' class="btn btn-xs btn-info" onclick=""><span><i class="fa fa-chevron-right" title="Assign Goods"></i></span></button>'
                                            ]).draw(false);
                                        }else{
                                            item = reqs[it]['itid'];
                                            var rowNode = t.row.add([
                                                itmCnt,
                                                reqs[it]['itnm']+" | "+reqs[it]['itcd']+" | MODEL - "+reqs[it]['mdl']+" ("+reqs[it]['mlcd']+")<br>" +
                                                "Requested QTY : <strong>"+reqs[it]['reqty']+"</strong><input type='hidden' name='reqtyEdt[]' id='' value='"+reqs[it]['reqty']+"'/>",
                                                '',
                                                '',
                                                '',
                                                '',
