        ...
        <div class="row form-horizontal">
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-4 col-xs-12 control-label">Permission Type</label>
    ...
    <div class="panel panel-default block" id="taba" style="display: none">
        <div>
            <ul class="nav nav-tabs nav-pills">
                <li class="active"><a href="#tabs-1" role="tab" data-toggle="tab">Basic
                        Permission</a>
                </li>
                <li><a href="#tabs-2" role="tab" data-toggle="tab"> Advance Permission</a></li>
                <li><a href="#tabs-3" role="tab" data-toggle="tab"> Special Permission </a></li>
                <li><a href="#tabs-4" role="tab" data-toggle="tab"> Module Permission </a></li>
                <li id="tb5"><a href="#tabs-5" role="tab" id="ttb5"> Page Access </a></li>
            </ul>
                            ...
                            <div class="table-responsive">
                                <table class="table datatable table-bordered"
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center" style="color: dodgerblue">Re Activate</th>
