        ...
        <div class="app-sidebar app-navigation app-navigation-fixed scroll app-navigation-style-default app-navigation-open-hover dir-left"
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="#"><span class="nav-icon-hexa">Ue</span> UI Elements<span
                                    class="label label-success label-bordered label-ghost">new</span></a>
                        <ul>
                            <li><a href="components-blocks-panels.html"><span class="nav-icon-hexa">Bp</span> Blocks &
                                    Panles</a></li>
                            <li><a href="components-widgets.html"><span class="nav-icon-hexa">Wi</span> Widgets &
                                    Informers</a></li>
                            <li><a href="components-tabs-accordion.html"><span class="nav-icon-hexa">Ta</span> Tabs &
                                    Accordions</a></li>
                            <li><a href="components-alerts-notifications.html"><span class="nav-icon-hexa">An</span>
                                    Alerts & Notifications</a></li>
                            <li><a href="components-modals-popups.html"><span class="nav-icon-hexa">Mp</span> Modals &
                                    Popups</a></li>
                            <li><a href="components-dropdowns.html"><span class="nav-icon-hexa">Dd</span> Dropdowns</a>
                            </li>
                            <li><a href="components-buttons.html"><span class="nav-icon-hexa">Bt</span> Buttons</a></li>
                            <li><a href="components-progressbar.html"><span class="nav-icon-hexa">Pb</span> Progress
                                    Bars</a></li>
                            <li><a href="components-pagination.html"><span class="nav-icon-hexa">Pt</span>
                                    Pagination</a></li>
                            <li><a href="components-spinners.html"><span class="nav-icon-hexa">Sp</span> Spinners</a>
                            </li>
                            <li><a href="components-tour.html"><span class="nav-icon-hexa">To</span> Tour</a></li>
                            <li><a href="components-timeline.html"><span class="nav-icon-hexa">To</span> Timeline <span
                                            class="label label-success label-bordered label-ghost">new</span></a></li>
                            <li><a href="components-help-classes.html"><span class="nav-icon-hexa">Hc</span> Help
                                    Classes</a></li>
                            <li>
                                <a href="#"><span class="nav-icon-hexa">Lt</span> Lists</a>
                                <ul>
                                    <li><a href="components-lists.html"><span class="nav-icon-hexa">Bl</span> Basic
                                            Lists</a></li>
                                    <li><a href="components-user-contacts.html"><span class="nav-icon-hexa">Uc</span>
                                            User & Contacts</a></li>
                                    <li><a href="components-tiles.html"><span class="nav-icon-hexa">Te</span> Tiles</a>
                                    </li>
                                    <li><a href="components-news-info.html"><span class="nav-icon-hexa">Ni</span> News &
                                            Info</a></li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li><a href="components-typography.html"><span class="nav-icon-hexa">Tp</span>
                                            Typography</a></li>
                                    <li><a href="components-labels-badges.html"><span class="nav-icon-hexa">Lb</span>
                                            Labels & Badges</a></li>
                                    <li><a href="components-text-heading.html"><span class="nav-icon-hexa">Th</span>
                                            Text Heading</a></li>
                                    <li><a href="components-heading.html"><span class="nav-icon-hexa">Pb</span> Page &
                                            Block Heading</a></li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="components-features-gallery.html"><span class="nav-icon-hexa">Cg</span> Compact
                                    Gallery</a></li>
                            <li><a href="components-features-tips.html"><span class="nav-icon-hexa">Tp</span> Tips</a>
                            </li>
                            <li><a href="components-features-loading.html"><span class="nav-icon-hexa">Ld</span> Loading</a>
                            </li>
                            <li><a href="components-features-statusbar.html"><span class="nav-icon-hexa">Sb</span>
                                    Status Bar</a></li>
                            <li><a href="components-features-preview.html"><span class="nav-icon-hexa">Pv</span> Preview</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="components-icons-fontawesome.html"><span class="nav-icon-hexa">Fa</span> Font
                                    Awesome</a></li>
                            <li><a href="components-icons-linearicons.html"><span class="nav-icon-hexa">Li</span>
                                    Linearicons</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li><a href="components-tables-default.html"><span class="nav-icon-hexa">Df</span>
                                    Default</a></li>
                            <li><a href="components-tables-sortable.html"><span class="nav-icon-hexa">Sa</span> Sortable</a>
                            </li>
                            <li><a href="components-tables-export.html"><span class="nav-icon-hexa">Et</span> Export
                                    Tables</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li><a href="components-charts-chartjs.html"><span class="nav-icon-hexa">Cj</span> Chart.js</a>
                            </li>
                            <li><a href="components-charts-morris.html"><span class="nav-icon-hexa">Mc</span> Morris
                                    Charts</a></li>
                            <li><a href="components-charts-rickshaw.html"><span class="nav-icon-hexa">Rc</span> Rickshaw
                                    Charts</a></li>
                            <li><a href="components-charts-other.html"><span class="nav-icon-hexa">Ot</span> Other</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li><a href="components-maps-jvectormap.html"><span class="nav-icon-hexa">Jm</span>
                                    jVectorMap</a></li>
                            <li><a href="components-maps-google.html"><span class="nav-icon-hexa">Gm</span> Google Maps</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="contact-controls">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-left">
                                    <li><a href="<?= base_url();?>admin"><span class="icon-users"></span> Master Setting</a></li>
