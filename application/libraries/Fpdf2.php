...
class FPDF2
{
    ...
    function Header()
    {
        ...
        if (!empty($_SESSION['rpt_logo'])) {
            $img = 'uploads/report_logo/' . $_SESSION['rpt_logo'];
        } else {
            $img = 'uploads/report_logo/default.jpg';
        }

        $this->Image($img, 10, 5, 40, 18, '');
        $this->SetXY(9, 28);
    ...
    function Footer()
    {
        ...
        $this->SetXY(-15, -10);
        $this->Cell(10, 6, 'Copyright@' . $cy . ' - www.gdcreations.com', 0, 1, 'R');
        $this->SetXY(4, -10);
        $this->Cell(0, 6, 'Printed : ' . $usr . ' | ' . $date, 0, 1, 'L');
        $this->SetXY(4, -10);
